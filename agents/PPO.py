...
class PPO(Agent):
    def __init__(
        ...
        self.actor = Network(8, 128, self.act_dim).to(self.device)
        self.critic = Network(8, 128, 1).to(self.device)
    ...
    def rollout(self) -> tuple:
        ...
        while t < self.timesteps_per_batch:
            ...
            for ep_t in range(self.max_timesteps_per_episode):
                ...
                print(self.action_to_move(action.argmax().item()), reward, done)
